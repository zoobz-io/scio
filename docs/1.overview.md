...
- [atom](https://github.com/zoobz-io/atom) — Type-segregated struct decomposition
- [grub](https://github.com/zoobz-io/grub) — Provider-agnostic storage
- [edamame](https://github.com/zoobz-io/edamame) — SQL query execution
